...
public partial class Day8
{
    ...
    private static (string, Dictionary<string, (string, string)>) ParseInput()
    {
        ...
        foreach (string nodeLine in splitInput[2..])
        {
            Match match = LinePattern().Match(nodeLine);
    ...
    [GeneratedRegex(@"(?<from>.{3}) \= \((?<left>.{3}), (?<right>.{3})\)", RegexOptions.Compiled)]
    private static partial Regex LinePattern();
    private const string input = @"
